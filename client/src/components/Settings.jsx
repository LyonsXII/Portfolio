  ...
  return (
    <div>
      <div className="settingsContainer" style={{color: theme.textColor}}>
        ...
        <div className="settingsButton" style={{backgroundColor: hoverText == "Home" ? theme.secondaryColor : theme.primaryColor}} onMouseOver={() => {updateHoverText("Home")}} onMouseLeave={() => {resetHoverText()}}>
