    ...
    <div>
      <div className="settingsContainer" style={{backgroundColor: theme.backgroundColor}}>
        ...
        <div className="settingsButtonContainer">
          <div className="settingsButton" style={hoverText == "Settings" ? highlighted : null} onMouseOver={() => {updateHoverText("Settings")}} onMouseLeave={() => {resetHoverText()}}>
          ...
          <div className="settingsButton" style={hoverText == "Theme" ? highlighted : null} onMouseOver={() => {updateHoverText("Theme")}} onMouseLeave={() => {resetHoverText()}}>
        ...
        S409.03,254.503,397.61,254.503z"/>
          ...
          <div className="settingsButton" style={hoverText == "Colour" ? highlighted : null} onMouseOver={() => {updateHoverText("Colour")}} onMouseLeave={() => {resetHoverText()}}>
          ...
          <a href="https://github.com/LyonsXII">
            <div className="settingsButton settingsButtonLower" style={hoverText == "Github" ? highlighted : null} onMouseOver={() => {updateHoverText("Github")}} onMouseLeave={() => {resetHoverText()}}>
            <img src="./icons/github.png"></img>
            </div>
          </a>
          <a href="https://www.linkedin.com/in/michael-lyons-60186b170/" >
            <div className="settingsButton settingsButtonLower" style={hoverText == "LinkedIn" ? highlighted : null} onMouseOver={() => {updateHoverText("LinkedIn")}} onMouseLeave={() => {resetHoverText()}}>
