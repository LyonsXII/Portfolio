    ...
    <div>
      <div className="settingsContainer" style={{color: theme.textColor}}>
        <div className="settingsTextContainer">
          ...
          <div className="settingsButton settingsButtonHoverTextBottom" style={{backgroundColor: theme.primaryColor, visibility: hoverText == "LinkedIn" ? "visible" : "hidden"}}>
            <h3>LinkedIn</h3>
          </div>
        </div>

        <div className="settingsButtonContainer">
        <div className="settingsButton" style={{backgroundColor: hoverText == "Home" ? theme.secondaryColor : theme.primaryColor}} onMouseOver={() => {updateHoverText("Home")}} onMouseLeave={() => {resetHoverText()}} onClick={props.home}>
            <svg width="800px" height="800px" viewBox="-2 2 28 28" >
              <path fill="none" stroke="black" strokeWidth="3.5px" strokeLinejoin="round" strokeLinecap="round" d="M19.469 12.594l3.625 3.313c0.438 0.406 0.313 0.719-0.281 0.719h-2.719v8.656c0 0.594-0.5 1.125-1.094 1.125h-4.719v-6.063c0-0.594-0.531-1.125-1.125-1.125h-2.969c-0.594 0-1.125 0.531-1.125 1.125v6.063h-4.719c-0.594 0-1.125-0.531-1.125-1.125v-8.656h-2.688c-0.594 0-0.719-0.313-0.281-0.719l10.594-9.625c0.438-0.406 1.188-0.406 1.656 0l2.406 2.156v-1.719c0-0.594 0.531-1.125 1.125-1.125h2.344c0.594 0 1.094 0.531 1.094 1.125v5.875z"/>

              <path fill="#ededed" d="M19.469 12.594l3.625 3.313c0.438 0.406 0.313 0.719-0.281 0.719h-2.719v8.656c0 0.594-0.5 1.125-1.094 1.125h-4.719v-6.063c0-0.594-0.531-1.125-1.125-1.125h-2.969c-0.594 0-1.125 0.531-1.125 1.125v6.063h-4.719c-0.594 0-1.125-0.531-1.125-1.125v-8.656h-2.688c-0.594 0-0.719-0.313-0.281-0.719l10.594-9.625c0.438-0.406 1.188-0.406 1.656 0l2.406 2.156v-1.719c0-0.594 0.531-1.125 1.125-1.125h2.344c0.594 0 1.094 0.531 1.094 1.125v5.875z"/>
            </svg>
          </div>
          <div className="settingsButton" style={{backgroundColor: hoverText == "Settings" ? theme.secondaryColor : theme.primaryColor}} onMouseOver={() => {updateHoverText("Settings")}} onMouseLeave={() => {resetHoverText()}}>
          ...
          <div className="settingsButton" style={{backgroundColor: hoverText == "Theme" ? theme.secondaryColor : theme.primaryColor}} onClick={toggleBg} onMouseOver={() => {updateHoverText("Theme")}} onMouseLeave={() => {resetHoverText()}}>
        ...
        S409.03,254.503,397.61,254.503z"/>
          ...
          <div className="settingsButton" style={{backgroundColor: hoverText == "Colour" ? theme.secondaryColor : theme.primaryColor}} onClick={toggleTheme} onMouseOver={() => {updateHoverText("Colour")}} onMouseLeave={() => {resetHoverText()}}>
