...
function Faraday(n, r, sides) {
  ...
  const centerGradient = getCenterAverage(magnitudeGradient).toFixed(4);

  return { uu: uu, uu_heat : uu_heat, diskXValues : diskXValues, diskYValues : diskYValues, centerGradient: centerGradient }
}
